/* Domaine 3 — données générées ; schéma : data/SCHEMA.md */
...
window.CISSP_DATA.domains[3] = {
      ...
      "slides": [
        ...
        },
        {
          ...
          "schema": {
            "type": "flow",
            "items": [
              "IaaS : client gère le plus",
              "PaaS : partage intermédiaire",
              "SaaS : fournisseur gère le plus"
            ]
          },
      ...
      "slides": [
        ...
        },
        {
          ...
          "schema": {
            ...
            "items": [
              "Root CA (hors ligne)",
              "CA intermédiaires / politiques",
              "Certificats utilisateurs et serveurs"
            ]
          },
  ...
  "quiz": [
    ...
    },
    {
      ...
      "choix": [
        ...
        "Protéger la confidentialité des données classifiées",
    ...
    },
    {
      ...
      "choix": [
        "Les Integrity Verification Procedures (IVP)",
        "Les Unconstrained Data Items (UDI)",
        "Les utilisateurs authentifiés",
        "Les Transformation Procedures (TP)"
      ],
      "reponse": 3,
    ...
    },
    {
      ...
      "choix": [
        "Le Protection Profile (PP)",
        "Le Security Assurance Requirement (SAR)",
        "Le Security Target (ST)",
        "La Target of Evaluation (TOE)"
      ],
      "reponse": 2,
    ...
    },
    {
      ...
      "choix": [
        "Certifié pour un usage militaire uniquement",
        "Formellement vérifié, conçu et testé",
        "Doté d'un chiffrement AES-256 obligatoire",
        "Impossible à compromettre"
      ],
      "reponse": 1,
    ...
    },
    {
      ...
      "choix": [
        "Fail-secure, car le datacenter reste protégé",
        "Fail-safe, car la protection des personnes prime",
        "Fail-closed, car la confidentialité est maintenue",
        "Secure defaults, car c'est la configuration d'usine"
      ],
      "reponse": 1,
    ...
    },
    {
      ...
      "choix": [
        "Chiffrer la base avec AES",
        "Ajouter un salt unique avant hachage",
        "Doubler la longueur du hash",
    ...
    },
    {
      ...
      "choix": [
        "Le certificate practice statement (CPS)",
        "Le serveur OCSP",
    ...
    },
    {
      ...
      "choix": [
        ...
        "Métaux combustibles",
        "Combustibles ordinaires (bois, papier)",
    ...
    },
    {
      ...
      "choix": [
        ...
        "Des bollards (bornes anti-véhicules)",
        "Un tourniquet à badge"
      ],
      "reponse": 2,
    ...
    },
    {
      ...
      "pourquoi": [
        "Hors périmètre : la dérive des coûts est un enjeu FinOps, pas la lacune de sécurité la plus critique.",
        "Réponse de technicien : l'homogénéité d'éditeur est un confort opérationnel, pas une lacune de sécurité structurelle.",
        "Correct : le plan de contrôle IAM (rôles, clés, fédération) est la surface d'attaque dominante du IaaS — c'est la rupture de modèle que le lift-and-shift ignore.",
        "Factuellement faible : la plupart des IaaS chiffrent les volumes par défaut — et ce n'est pas la rupture de modèle en cause."
      ],
      "difficulte": 3
    },
    {
      ...
      "reponse": 0,
      "explication": "Les niveaux FIPS 140-3 s'obtiennent par certification du module dans son ensemble (exigences physiques croissantes : preuves d'effraction niveau 2, résistance/réponse niveau 3). Un ajout logiciel externe ne modifie pas le niveau certifié.",
      "pourquoi": [
        "Correct : le niveau est une propriété certifiée du module, incluant des exigences physiques — l'écart ne se comble pas par du code applicatif.",
        "Piège du contournement : substituer son propre jugement à l'exigence du client sans analyse contractuelle ni de risque n'est pas une position défendable.",
        "Techniquement vrai mais hors sujet : la qualité du code additionnel ne change rien au niveau de certification du module.",
  ...
  "quizEn": [
    ...
    },
    {
      ...
      "choix": [
        "DMZ with screened subnet",
        "Air-gapped network",
        "Hub-and-spoke VPN concentrators",
    ...
    },
    {
      ...
      "choix": [
        ...
        "Security Functional Requirement catalog",
        "Security Target"
      ],
      "reponse": 3,
    ...
    },
    {
      ...
      "choix": [
        "A software keystore encrypted with AES",
        "A TPM chip on each server motherboard",
        "A Hardware Security Module (HSM)",
        "A smart card issued to the administrator"
      ],
      "reponse": 2,
  ...
  "flashcards": [
    {
      "recto": "Zero Trust",
      "verso": "Modèle de sécurité qui n'accorde aucune confiance implicite : chaque requête est authentifiée, autorisée et chiffrée avant l'accès. Devise : « never trust, always verify » ; posture « assume breach »."
    },
    {
      "recto": "Defense in Depth",
      "verso": "Utilisation de plusieurs contrôles en série (couches successives) afin que la défaillance d'un seul contrôle n'expose ni les systèmes ni les données."
    },
    {
      "recto": "Fail-safe vs Fail-secure (physique)",
      "verso": "Fail-safe : la défaillance protège les PERSONNES (les portes s'ouvrent). Fail-secure : la défaillance protège les ACTIFS (les portes restent verrouillées). La vie humaine prime toujours."
    },
    {
      "recto": "Privacy by Design (PbD)",
      "verso": "Intégration de la protection de la vie privée dès la conception : proactif, privé par défaut, intégré, positive-sum, protection de bout en bout, transparent, centré sur l'utilisateur (7 principes)."
    },
    {
      "recto": "Bell-LaPadula",
      "verso": "Modèle de CONFIDENTIALITÉ (1973). Simple property : no read up. Star property : no write down. Ne traite pas les canaux cachés."
    },
    {
      "recto": "Biba",
      "verso": "Modèle d'INTÉGRITÉ (1977), inverse de Bell-LaPadula. Simple integrity : no read down. Star integrity : no write up. Invocation property : pas d'appel vers une intégrité supérieure."
    },
    {
      "recto": "Clark-Wilson",
      "verso": "Modèle d'intégrité fondé sur le triplet sujet-programme-objet : les CDI ne sont manipulés que par des Transformation Procedures (TP), auditées par des IVP. Impose des transactions bien formées et la séparation des tâches."
    },
    {
      "recto": "Brewer-Nash",
      "verso": "Modèle « ethical wall » qui prévient les conflits d'intérêts : les droits d'accès changent dynamiquement selon l'activité passée de l'utilisateur (ex. cabinet servant deux concurrents)."
    },
    {
      "recto": "TOE / PP / ST (Common Criteria)",
      "verso": "TOE : Target of Evaluation, le produit évalué. PP : Protection Profile, les besoins du client (« je veux »). ST : Security Target, les prétentions de sécurité du fournisseur."
    },
    {
      "recto": "EAL (Evaluation Assurance Level)",
      "verso": "Échelle 1 à 7 mesurant la rigueur de l'ÉVALUATION Common Criteria : EAL1 testé fonctionnellement → EAL4 méthodiquement conçu, testé et revu → EAL7 formellement vérifié, conçu et testé."
    },
    {
      "recto": "Reference Monitor (NEAT)",
      "verso": "Concept théorique contrôlant chaque accès sujet-objet. Propriétés NEAT : Non-bypassable, Evaluable, Always invoked, Tamper-proof. Implémenté par le security kernel."
    },
    {
      "recto": "TPM (Trusted Platform Module)",
      "verso": "Puce cryptographique inviolable de la carte mère : opérations cryptographiques matérielles, génération et protection de clés, remote attestation (hash de la configuration système). Exemple de HSM intégré."
    },
    {
      "recto": "HSM (Hardware Security Module)",
      "verso": "Cryptoprocesseur dédié servant à gérer et stocker les clés numériques, accélérer les opérations cryptographiques et les signatures, et renforcer l'authentification."
    },
    {
      "recto": "VM Escape",
      "verso": "Attaque exploitant une faille de l'hyperviseur pour sortir d'une VM et atteindre l'hôte. Mitigations : patcher l'hyperviseur, isoler les systèmes très sensibles sur des machines physiques séparées."
    },
    {
      "recto": "Cloud Shared Responsibility Model",
      "verso": "Le CSP sécurise LE cloud (infrastructure), le client sécurise ce qui est DANS le cloud (données, identités, configurations). En IaaS le client gère le plus ; en SaaS, le moins."
    },
    {
      "recto": "SCADA / ICS",
      "verso": "Systèmes de contrôle industriel (operational technology) : SCADA supervise des installations distribuées, DCS pilote une usine, PLC est un automate. Mitigation clé : segmentation réseau + patches approuvés par le vendeur."
    },
    {
      "recto": "Symétrique vs Asymétrique",
      "verso": "Symétrique : une clé partagée, rapide, chiffrement de masse, confidentialité seule, n(n-1)/2 clés. Asymétrique : paire publique/privée, plus lent, résout l'échange de clés, apporte authentification et non-répudiation."
    },
    {
      "recto": "Formule des clés symétriques",
      "verso": "n(n-1)/2 clés pour connecter n participants deux à deux. Exemples : 10 personnes → 45 clés ; 20 personnes → 190 clés ; 100 personnes → 4950 clés."
    },
    {
      "recto": "AES (Rijndael)",
      "verso": "Standard symétrique du gouvernement américain : clés de 128, 192 ou 256 bits, blocs fixes de 128 bits. Remplace DES (insécurisé) ; 3DES déprécié par le NIST en 2023."
    },
    {
      "recto": "RSA vs ECC",
      "verso": "RSA : repose sur la factorisation de grands nombres premiers (« factoring attack » = RSA). ECC : logarithme discret elliptique ; 256 bits ECC ≈ 3072 bits RSA, idéal pour les appareils contraints."
    },
    {
      "recto": "Mode GCM",
      "verso": "Galois/Counter Mode : mode de chiffrement authentifié combinant CTR et authentification de Galois. Fournit confidentialité ET intégrité ; très rapide, reconnu par le NIST."
    },
    {
      "recto": "Hash / Collision",
      "verso": "Fonction à sens unique produisant une empreinte de taille fixe (digest). Collision : deux entrées différentes donnent le même hash — signe de faiblesse de l'algorithme."
    },
    {
      "recto": "Salting vs Key stretching",
      "verso": "Salting : aléa unique ajouté avant hachage, neutralise les rainbow tables. Key stretching : rend le hachage volontairement lent (PBKDF2, bcrypt, scrypt, Argon2) pour freiner le brute force."
    },
    {
      "recto": "Signature numérique",
      "verso": "Hash du message chiffré avec la clé PRIVÉE de l'émetteur ; vérification avec sa clé publique. Garantit intégrité, authentification, non-répudiation — pas la confidentialité. FIPS 186-5 : RSA, ECDSA, EdDSA."
    },
    {
      "recto": "PKI : CA et RA",
      "verso": "La Certification Authority émet les certificats liant identité et clé publique ; la Registration Authority vérifie l'identité du demandeur. Root CA hors ligne, CA intermédiaires émettrices ; la PKI publie la révocation."
    },
    {
      "recto": "Key escrow / m of n",
    ...
    {
      "recto": "Side-channel / Timing attack",
      "verso": "Attaques exploitant les traces physiques du calcul : consommation électrique, émissions électromagnétiques (TEMPEST), temps d'exécution. Parade au timing : exécution en temps constant ou délais aléatoires."
    },
    {
      "recto": "Golden ticket vs Silver ticket",
      "verso": "Silver ticket : hash d'un compte de service → ticket TGS pour CE service. Golden ticket : hash du compte KRBTGT → tickets Kerberos à volonté, contrôle quasi total de l'Active Directory."
    },
    {
      "recto": "Post-Quantum Cryptography / HNDL",
      "verso": "PQC : algorithmes classiques résistants au quantique (ex. lattice-based). Menace « Harvest Now, Decrypt Later » : intercepter et stocker aujourd'hui des données chiffrées pour les déchiffrer demain avec un ordinateur quantique."
    },
    {
      "recto": "CPTED",
      "verso": "Crime Prevention Through Environmental Design : réduire le crime par l'architecture passive. Trois principes : natural access control, natural surveillance, natural territorial reinforcement."
    },
    {
      "recto": "Incidents électriques",
      "verso": "Fault : perte momentanée ; blackout : coupure prolongée. Sag : sous-tension momentanée ; brownout : prolongée. Spike : surtension momentanée ; surge : prolongée. Inrush : appel de courant initial."
    },
    {
      "recto": "Fire triangle et classes d'extincteurs",
      "verso": "Triangle : fuel + heat + oxygen + réaction chimique — retirer un élément éteint le feu. Classes : A combustibles, B liquides, C électrique, D métaux, K cuisine."
    },
    {
      "recto": "Systèmes sprinkler",
      "verso": "Wet pipe : toujours en eau, décharge immédiate. Dry pipe : gaz inerte, eau au déclenchement. Pre-action : double détection, LE choix pour les datacenters. Deluge : gros volumes d'eau."
    },
    {
      "recto": "Security modes : dedicated vs system high",
      "verso": "Dedicated : clearance, approbation d'accès ET need-to-know pour TOUTES les informations du système. System high : clearance et approbation pour tout, mais need-to-know seulement pour CERTAINES informations."
    },
    {
      "recto": "Security modes : compartmented vs multilevel",
      "verso": "Compartmented : clearance pour TOUTES les informations, mais approbation et need-to-know limités à chaque compartiment. Multilevel (controlled) : certains utilisateurs n'ont PAS la clearance pour tout — le système (TCB) applique la séparation des niveaux."
    },
    {
      "recto": "TCSEC (Orange Book) / ITSEC",
      "verso": "TCSEC (USA) : niveaux D (minimal) → C1/C2 (discretionary) → B1/B2/B3 (mandatory, labels) → A1 (verified design) ; confidentialité uniquement. ITSEC (Europe) : fonctionnalité (F) et assurance (E1-E6) séparées. Remplacés par les Common Criteria : C2 ≈ EAL3, B1 ≈ EAL4, A1/E6 ≈ EAL7."
    },
    {
      "recto": "Homomorphic encryption / Confidential computing",
      "verso": "Homomorphic encryption : calculs effectués directement sur des données CHIFFRÉES, sans jamais les déchiffrer (cloud non fiable). Confidential computing : traitement dans une enclave matérielle isolée (TEE) du processeur. Les deux protègent la donnée « in use »."
    },
    {
      "recto": "Split knowledge vs Dual control",
      "verso": "Split knowledge : la connaissance d'une clé est fragmentée, personne ne SAIT tout. Dual control : une opération critique exige deux personnes simultanément, personne ne FAIT rien seul. Combinés dans le contrôle m of n. Exemple historique de key escrow : Clipper chip (algorithme Skipjack), clé scindée entre deux agences."
    }
  ]
};
