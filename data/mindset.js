// Module Mindset — « Penser et parler comme un CISSP »
// Inspiré de « How to Think Like a Manager » (Luke Ahmed) et des retours de la communauté (r/cissp, Destination Certification).
// L'examen CISSP ne teste pas vos compétences de technicien : il teste votre jugement de security manager.
...
window.CISSP_DATA.mindset = {
  ...
  // ============================================================
  // DRILLS — S'ENTRAÎNER À ÉLIMINER PUIS CHOISIR
  // ============================================================
  drills: [
    {
