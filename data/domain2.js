...
window.CISSP_DATA.domains[2] = {
  ...
  quiz: [
    ...
    },
    {
      ...
      reponse: 0,
      explication:
        "Dès qu'un litige est raisonnablement anticipé, l'obligation de préservation naît : le legal hold suspend la destruction pour le périmètre concerné, défini avec le juridique et documenté. Appliquer la politique malgré tout exposerait à une accusation de destruction de preuves (spoliation) ; tout exporter est disproportionné et accroît l'exposition ; attendre l'assignation formelle arriverait trop tard.",
      difficulte: 3,
      pourquoi: [
