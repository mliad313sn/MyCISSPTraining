...
- **🧪 Banque de 1080 questions** (786 en français + 294 en anglais pour la simulation CAT) : style examen (« MEILLEUR », « EN PREMIER », point de vue manager), correction immédiate avec **explication détaillée option par option** (chaque distracteur réfuté et son type de piège nommé), difficultés calibrées — qualité auditée contre le format CAT réel (voir `docs/EVALUATION-CAT.md`).
