    ...
    document.getElementById("app").innerHTML = `
      <div style="max-width:840px;margin:0 auto;--dc:${d ? d.couleur : "#4f8ef7"}">
        ...
        <div class="card" style="margin-top:1rem">
          <div style="font-size:2rem">${sc.icone || ""}</div>
    ...
    document.getElementById("app").innerHTML = `
      <div style="max-width:840px;margin:0 auto;--dc:${d ? d.couleur : "#4f8ef7"}">
        <div class="q-head" style="display:flex;justify-content:space-between;align-items:center;gap:.6rem;margin-bottom:1rem;flex-wrap:wrap">
          <span class="badge">${esc(sc.titre)}</span>
    ...
    document.getElementById("app").innerHTML = `
      <div style="max-width:840px;margin:0 auto">
        <div class="card" style="text-align:center">
          <div style="font-size:3rem">${pct >= 80 ? `<span style="color:var(--ok)">${icon("award", 36)}</span>` : `<span style="color:var(--warn)">${icon("alert", 34)}</span>`}</div>
        ...
        <div class="card" style="margin-top:1rem">
          <h3 style="color:var(--primary);margin-bottom:.6rem">Ce qu'il faut retenir</h3>
          <p style="line-height:1.7">${esc(sc.debrief)}</p>
          <h3 style="color:var(--primary);margin:1.2rem 0 .6rem">Concepts traversés</h3>
